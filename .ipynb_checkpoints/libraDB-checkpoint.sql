DROP DATABASE IF EXISTS LibraDB;
CREATE DATABASE LibraDB;
USE LibraDB;
...
# Here, we will first create the tables fcityor all the necessary Entity Sets:
...
(2, 100.00, 4, '2019-10-20', 'NOT PAID'),
(3, 100.00, 2, '2019-12-14', 'NOT PAID');
